...
@section('extra-js')
    <script src="{{ asset('js/dedicated.js') }}" defer></script>
@endsection
@section('content')
    <header class="header">
        <h1 class="title">Your new Dedicated server</h1>
    </header>
            ...
            <div class="plan-groups">
                <div class="plan-list" role="list">
                    ...
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-1">
                        <input type="radio" name="plan" value="CLTs-1" data-price-month="4.94" data-cores="1" data-ram="2" data-nvme="30" data-gbps="25" />
                    ...
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-2">
                        <input type="radio" name="plan" value="CLTs-2" data-price-month="9.89" data-cores="2" data-ram="4" data-nvme="60" data-gbps="25" checked />
                        <header class="plan-card__head">
                    ...
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-3">
                        <input type="radio" name="plan" value="CLTs-3" data-price-month="19.77" data-cores="4" data-ram="8" data-nvme="120" data-gbps="25" />
                        <header class="plan-card__head">
                    ...
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-4">
                        <input type="radio" name="plan" value="CLTs-4" data-price-month="39.54" data-cores="6" data-ram="16" data-nvme="240" data-gbps="25" />
                        <header class="plan-card__head">
                ...
                <div class="plan-list" role="list">
                    <!-- CLTs-5 -->
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-5">
                        <input type="radio" name="plan" value="CLTs-5" data-price-month="4.94" data-cores="1" data-ram="2" data-nvme="30" data-gbps="25" />
                        <header class="plan-card__head">
                            <h4 class="plan-name">CLTs-5</h4>
                            <div class="plan-price">
                                <strong class="price"><span data-price>4.94</span> €/month</strong>
                            </div>
                        </header>
                    ...
                    <!-- CLTs-6 -->
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-6">
                        <input type="radio" name="plan" value="CLTs-6" data-price-month="9.89" data-cores="2" data-ram="4" data-nvme="60" data-gbps="25" />
                        <header class="plan-card__head">
                            <h4 class="plan-name">CLTs-6</h4>
                            <div class="plan-price">
                                <strong class="price"><span data-price>9.89</span> €/month</strong>
                            </div>
                        </header>
                    ...
                    <!-- CLTs-7 -->
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-7">
                        <input type="radio" name="plan" value="CLTs-7" data-price-month="19.77" data-cores="4" data-ram="8" data-nvme="120" data-gbps="25" />
                        <header class="plan-card__head">
                            <h4 class="plan-name">CLTs-7</h4>
                            <div class="plan-price">
                                <strong class="price"><span data-price>19.77</span> €/month</strong>
                            </div>
                        </header>
                    ...
                    <!-- CLTs-8 -->
                    <label class="plan-card" role="listitem" data-plan-code="CLTs-8">
                        <input type="radio" name="plan" value="CLTs-8" data-price-month="39.54" data-cores="6" data-ram="16" data-nvme="240" data-gbps="25" />
                        <header class="plan-card__head">
                            <h4 class="plan-name">CLTs-8</h4>
                            <div class="plan-price">
                                <strong class="price"><span data-price>39.54</span> €/month</strong>
                            </div>
                        </header>
