            ...
            <div class="plan-groups">
                ...
                <article class="plan-group is-active" data-group="shared">
                    <header class="plan-group__header">
                        <h3 class="subtitle">AMD</h3>
                        <p class="muted">
                            Cloud servers with guaranteed performance based on AMD EPYC 9454 processors and NVMe storage
                            with RAM caching. They are ideally suited for demanding projects such as 1C, Bitrix, and game
                            servers, ensuring stability and high speed. Included are basic DDoS protection, a guaranteed
                    ...
                    <div class="plan-list" role="list">
                        ...
                        <label class="plan-card" role="listitem" data-plan-code="CLTs-3">
                            <input type="radio" name="plan" value="CLTs-3" data-price-month="19.77"
                                data-price-hour="0.05" data-cores="4" data-ram="8" data-nvme="120" data-gbps="25" />
                            <header class="plan-card__head">
