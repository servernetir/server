...
## ۱۰. قدم بعدی: پرتال کاربر (بدون WHMCS)

> **تصمیم گرفته‌شده (۳۱ تیر ۱۴۰۴):** WHMCS کنار گذاشته می‌شود. پرتال کاربر
> داخل خود لاراول ساخته خواهد شد. جزئیات دامنهٔ کار هنوز از کارفرما نیامده —
> **تا آن موقع کد WHMCS دست‌نخورده می‌ماند.**
