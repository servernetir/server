@php
  ...
  $types = ['whm'=>'WHM / cPanel (خودکار)','directadmin'=>'DirectAdmin (خودکار)','hetzner_storage'=>'فضای بکاپ — Hetzner Storage Box (خودکار)','rclone_storage'=>'ServerNet Backup Gateway (خودکار)','plesk'=>'Plesk (دستی)','vps'=>'VPS (دستی)','dedicated'=>'سرور اختصاصی (دستی)','generic'=>'عمومی (دستی)'];
  /*
