...
@section('title', __('ui.email_otp_subject'))
@section('preview', __('ui.email_otp_heading').' — '.$code)

@section('content')
@php $dir = app()->getLocale() === 'fa' ? 'rtl' : 'ltr'; @endphp

<h1 style="margin:0 0 14px; font-size:19px; font-weight:800; color:#0b1220;">{{ __('ui.email_otp_heading') }}</h1>

<p style="margin:0 0 20px; color:#3b4658;">{{ __('ui.email_otp_intro') }}</p>
