            ...
            */
            ...
            [
                ...
                'email_body' => '<p>{name} عزیز، تولدتان مبارک!</p>'
                    .'<p>به همین مناسبت <b>{credit} تومان</b> اعتبار هدیه به کیف پول شما اضافه شد.</p>'
                    .'<p>این هدیه تا <b>{days} روز</b> اعتبار دارد.</p>',
                'bale_body' => '{name} عزیز، تولدتان مبارک! {credit} تومان اعتبار هدیه به کیف پول شما اضافه شد (تا {days} روز معتبر).',
                'variables' => [
                    ['name' => 'name', 'desc' => 'نام کوچک مشتری'],
                    ['name' => 'credit', 'desc' => 'مبلغ هدیه به تومان'],
                    ['name' => 'days', 'desc' => 'مدت اعتبار هدیه (روز)'],
                ],
            ],
        ];
    }
