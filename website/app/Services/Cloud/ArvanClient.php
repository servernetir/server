...
class ArvanClient implements CloudProvider
{
    ...
    private function securityGroupIds(string $regionCode): array
    {
        ...
        |
        | پس یک selector دستی: شناسه یا نامِ گروه در تنظیمات. اگر پر باشد بر
        | انتخابِ خودکار مقدم است، اما فقط پس از آن‌که در فهرستِ **همین region**
        | دیده شد. هنگام شکستِ endpoint کورکورانه فرستادنش همان باگ اصلی است.
        |
