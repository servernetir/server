...
class AdminBaleCommands
{
    ...
    public function queue(): string
    {
        ...
        $lines = ['📋 صفِ پشتیبانی — '.fa_num((string) $rows->count()).' تیکتِ منتظر', ''];
