...
class AdminBaleCommands
{
    ...
    public function panel(): string
    {
        return implode("\n", [
            ...
            '  مشتری [نام/کد/موبایل] — جستجو یا فهرست',
            '  ایمیل‌ها — صندوقِ منتظرِ پاسخ',
            '  سلامت — وضعیتِ سامانه',
            '  وضعیت — این ربات به چه حسابی وصل است',
            '',
            '📞 تماس',
            '  تماس <شماره> — زنگ به هر شماره‌ای (اول شماره را نشان می‌دهد)',
            '  روی کارتِ مشتری و تیکت هم دکمهٔ تماس هست',
            '',
            ...
            '',
            '✨ تصحیح نگارش با هوش مصنوعی',
            '  تصحیح <متن> → متنِ خودت را صیقل می‌دهد و پیش از ارسال نشان می‌دهد',
            '  روی اعلانِ تیکت ریپلای بزنی، شماره لازم نیست',
            '  هیچ‌وقت خودکار نمی‌فرستد — تأیید با خودت است',
            '',
            '💸 هزینه',
            '  هزینه → دکمهٔ دسته‌ها می‌آید، بعد مبلغ را می‌فرستی',
            '  در همان دفترِ مالیِ پنل ثبت می‌شود (دکمه‌اش در منوی اصلی هم هست)',
            '',
            '🛒 از پروندهٔ مشتری (همه با دکمه)',
            '  مشتریِ جدید · فروشِ سرویس · تعلیق/فعال‌سازی · فاکتورِ تمدید',
            '  تأیید/ردِ رسیدِ بانکی · لغوِ فاکتور · خاتمهٔ سرویس',
            '',
            '🪪 احراز هویت (روی اعلانِ «نیازمندِ تأیید»)',
            '  مشاهدهٔ مدارک · تأیید · رد (با دلیل) — همه از داخلِ بله',
            '  و «تلاشِ دوبارهٔ تحویل» روی اعلانِ شکستِ تحویل',
            '',
            '⛔️ عمداً از ربات در دسترس نیست:',
            '  تغییرِ رمزِ مشتری · ورود به‌جای مشتری · حذفِ مشتری یا سرویس',
            '  ثبت/تمدیدِ دامنه · اعلانِ گروهی · تنظیمات و توکن‌ها',
            '  قیمت‌گذاری و کاتالوگ · بازکردنِ پلنِ قرنطینه · اتصالِ سرورِ موجود',
