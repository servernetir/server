...
یکی از دکمه‌های زیر را بزنید. '
    ...
    private function menu(): void
    {
        ...
        $this->sendButtons($d['text'], [
            ...
            [
                // 🔴 بی‌این دکمه، ثبتِ هزینه فقط با تایپِ کلمهٔ «هزینه» کار
                //    می‌کرد — یعنی کارفرما هیچ‌وقت نمی‌فهمید که اصلاً هست.
                //    قابلیتی که راهِ کشف ندارد، برای کاربر وجود ندارد.
                ['text' => '💸 ثبت هزینه', 'data' => self::CB_PREFIX.'xp'],
