 ...
 *   • مدارکِ احراز هویت — با یک استثنای صریح: کارفرما (۶ شهریور ۱۴۰۵) خواست
 *     مدارک را از خودِ بله ببیند و تأیید/رد کند؛ فایل‌ها فقط با دکمهٔ
 *     «مشاهدهٔ مدارک» و فقط به **چتِ متصلِ مدیر** می‌روند (AdminBaleWorker)،
 *     هرگز در صفحه‌های عمومیِ این کلاس چاپ نمی‌شوند
 *
