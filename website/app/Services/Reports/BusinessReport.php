        ...
        */
        ...
        return array_merge($spots, [
            ...
            [
                ...
                /*
                | ⚠️ از مرداد ۱۴۰۵ اجارهٔ سرور خودکار در دفتر ثبت می‌شود
                | (`servers:post-rent`)، ولی بقیهٔ هزینه‌ها هنوز دستی‌اند. متن
                | عمداً همین تفکیک را می‌گوید و «حالا درست است» ادعا نمی‌کند.
                */
                'why'   => 'اجارهٔ سرور از این پس **خودکار** ثبت می‌شود، ولی حقوق، '
                    .'تبلیغات، کارمزدِ درگاه و خریدِ عمدهٔ دامنه هنوز دستی وارد می‌شوند. '
                    .'پس سودِ «مالی و سود» تا وقتی آنها را ننویسید، هنوز خوش‌بینانه است.',
            ],
            [
