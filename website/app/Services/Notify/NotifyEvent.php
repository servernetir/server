...
final class NotifyEvent
{
    ...
    public const ALL = [
        ...
        */
        ...
        /*
        | پیش‌فاکتوری که ۷۲ ساعت پرداخت نشد و منقضی شد.
        |
        | ⚠️ مخاطب فقط **مشتری**: مدیر نباید به‌ازای هر سبدِ رهاشده یک پیام
        | بگیرد — همان سیلِ اعلانی که در این پروژه ثبت شده است.
        |
        | ⚠️ متغیرها عمداً فقط `number` است. هر متغیرِ اضافه‌ای که در الگو پر
        | نشود، هر دو خوانندهٔ الگو کلِ متن را دور می‌ریزند و به متنِ کد
        | برمی‌گردند — یعنی الگویی که مدیر ویرایش کرده بی‌صدا از کار می‌افتد.
        */
        'invoice_expired' => [
            'title' => 'انقضای پیش‌فاکتورِ پرداخت‌نشده', 'group' => 'billing',
