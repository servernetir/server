...
class AuditViewData
{
    public static function meta(): array
    {
        ...
        return [
            ...
            'fa'     => app()->getLocale() === 'fa',
            /*
             * تاریخِ امروز برای سربرگِ چاپ.
             *
             * 🔴 در PHP ساخته می‌شود نه در JS — قاعدهٔ ثبت‌شدهٔ پروژه: ریاضیِ
             * جلالی فقط یک پیاده‌سازی دارد. اگر مرورگر خودش تاریخِ شمسی بسازد،
             * دو پیاده‌سازی می‌شود و روزی یک روز اختلاف پیدا می‌کنند — روی
             * سندی که تاریخِ بررسی را ادعا می‌کند.
             */
            'today'  => sdate(now()),
