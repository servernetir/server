...
class CloudLocation extends Model
{
    ...
    public const CITIES_FA = [
        ...
        'hillsboro' => 'هیلزبورو',
        /*
        | Local Zoneهای زیرساختِ ۴ — بی‌این‌ها فروشگاه «آمریکا — Atlanta» را
        | کنارِ «آلمان — فالکن‌اشتاین» می‌گذاشت و فهرستِ مکان‌ها نیمه‌فارسی
        | می‌شد. نامِ نبود خطا نمی‌دهد، فقط بد دیده می‌شود — و همان بدی است که
        | مشتری آن را «سایتِ نیم‌کاره» می‌خوانَد.
        */
        'atlanta' => 'آتلانتا', 'denver' => 'دنور',
        'palo-alto' => 'پالو آلتو', 'seattle' => 'سیاتل',
        'vint-hill' => 'وینت هیل',
