...
class CloudPlan extends Model
{
     ...
     * «۱۲ ساعت اعتبار در لحظهٔ خرید» است نه «۱۲ ساعت دوامِ پس از خرید»
     * (خریدِ دقیقاً ۱۲× نرخ، ۱۱ ساعت دوام باقی می‌گذارد). اگر روزی معنیِ دوم
     * خواسته شد، فقط همین عدد ۱۳ می‌شود.
     */
    public const HOURLY_START_MIN_HOURS = 12;

    /** حداقلِ اعتبارِ لازم برای شروعِ ساعتی = ۱۲ ساعت (تومان). */
