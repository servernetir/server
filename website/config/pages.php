...
return [
    ...
    'terms' => [
        ...
        'sections' => [
            ...
            */
            ['fa' => ['t' => 'قیمت، مالیات و لوکیشن خدمات', 'b' => 'قیمت‌های نمایش‌داده‌شده در صفحات سایت جنبه‌ی اطلاع‌رسانی دارد و مبلغ قطعی هر سفارش، همراه مالیات و عوارض قانونی مطابق نرخ مصوب روز، در صفحه‌ی پرداخت محاسبه و در فاکتور رسمی درج می‌شود. خدمات ارائه‌شده در لوکیشن‌های خارج از ایران از طریق اپراتورهای زیرساخت ثالث تأمین می‌شود؛ مشتری می‌پذیرد که شرایط استفاده و سیاست مقابله با سوءاستفاده‌ی آن اپراتور و قوانین کشور محل استقرار داده بر سرویس او نیز حاکم است و نقض آن‌ها، نقض همین قرارداد محسوب می‌شود. مشتری آگاه است که با انتخاب لوکیشن خارجی، داده‌های او خارج از ایران نگهداری می‌شود و رعایت الزامات قانونی مرتبط با نوع داده و فعالیت خودش (از جمله داده‌های مشتریان او) بر عهده‌ی اوست. مالیات بر ارزش افزوده: سفارش‌هایی که به ریال یا تومان صادر و پرداخت می‌شوند مشمول مالیات بر ارزش افزوده با نرخ مصوب روز هستند و این مبلغ در صفحه‌ی پرداخت به قیمت پایه افزوده و در فاکتور رسمی جداگانه درج می‌شود. سفارش‌هایی که به یورو صادر می‌شوند مشمول مالیات بر ارزش افزوده‌ی ایران نیستند و مبلغی بابت آن دریافت نمی‌شود؛ مسئولیت هر مالیات یا عوارضی که طبق قوانین کشور محل اقامت مشتری بر او تعلق می‌گیرد بر عهده‌ی خود مشتری است. (پیش‌نویس؛ متن نهایی پس از تأیید مشاور حقوقی.)'],
             'en' => ['t' => 'Pricing, tax and service locations', 'b' => 'Prices shown on the website are informational; the final amount of each order, including applicable taxes and statutory charges at the current official rate, is calculated at checkout and stated on the official invoice. Services in locations outside Iran are provided through third-party infrastructure operators; the customer accepts that the operator\'s terms of use and abuse policy and the laws of the country where the data resides also govern the service, and violating them is a violation of this agreement. By choosing a foreign location the customer acknowledges that their data is stored outside Iran and that complying with the legal requirements applicable to their own data and activity (including their customers\' data) is their responsibility. Value added tax: orders invoiced and paid in Iranian rial or toman are subject to Iranian VAT at the current statutory rate; that amount is added to the base price at checkout and shown separately on the official invoice. Orders invoiced in euro are not subject to Iranian VAT and no such amount is charged; any tax or duty owed under the laws of the country where the customer resides remains the responsibility of the customer. (Working draft; final text after legal review.)'],
             'tr' => ['t' => 'Fiyat, vergi ve hizmet konumları', 'b' => 'Sitede gösterilen fiyatlar bilgilendirme amaçlıdır; her siparişin kesin tutarı, geçerli resmi orana göre vergi ve yasal kesintilerle birlikte ödeme sayfasında hesaplanır ve resmi faturada yer alır. İran dışındaki konumlarda hizmetler üçüncü taraf altyapı operatörleri üzerinden sağlanır; müşteri, operatörün kullanım şartlarının ve kötüye kullanım politikasının ve verinin bulunduğu ülkenin yasalarının da hizmeti için geçerli olduğunu kabul eder. Yabancı konum seçen müşteri, verilerinin İran dışında tutulduğunu ve kendi verileri ve faaliyetiyle ilgili yasal yükümlülüklere uymanın kendi sorumluluğunda olduğunu kabul eder. Katma değer vergisi: İran riyali veya tümeni ile faturalandırılan ve ödenen siparişler, yürürlükteki yasal oran üzerinden İran KDV’sine tabidir; bu tutar ödeme sayfasında temel fiyata eklenir ve resmi faturada ayrıca gösterilir. Euro ile faturalandırılan siparişler İran KDV’sine tabi değildir ve bu ad altında bir tutar tahsil edilmez; müşterinin ikamet ettiği ülkenin yasalarına göre doğan her türlü vergi veya harç müşterinin sorumluluğundadır. (Taslak; nihai metin hukuki incelemeden sonra.)']],
