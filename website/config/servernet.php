...
return [
    ...
    */
    ...
    'enterprise' => [
        ['icon' => 'factory', 'wide' => true, 'tag' => 'Core',
        ...
        ['icon' => 'wrench', 'wide' => true, 'tag' => '24/7',
    ...
    */
    'services_menu' => [
        ['icon' => 'rocket',   'fa' => ['t' => 'سایت‌ساز', 'd' => 'سریع‌ترین راه برای راه‌اندازی کسب‌وکار آنلاین'],      'en' => ['t' => 'Site Builder', 'd' => 'The fastest way to launch your business online'],   'tr' => ['t' => 'Site Oluşturucu', 'd' => 'Online işinizi başlatmanın en hızlı yolu']],
        ['icon' => 'umbrella', 'fa' => ['t' => 'پشتیبانی چتر آبی', 'd' => 'خدمات پشتیبانی باکیفیت و حرفه‌ای ۲۴ ساعته'],   'en' => ['t' => 'Premium Support', 'd' => 'Professional 24/7 support services'],            'tr' => ['t' => 'Premium Destek', 'd' => '7/24 profesyonel ve kaliteli destek']],
        ['icon' => 'flow',     'fa' => ['t' => 'خدمات دواپس', 'd' => 'مدیریت چالش‌های فناوری با رویکردی چابک و هوشمند'],  'en' => ['t' => 'DevOps Services', 'd' => 'Agile, intelligent technology management'],      'tr' => ['t' => 'DevOps Hizmetleri', 'd' => 'Teknoloji süreçlerinin çevik ve akıllı yönetimi']],
        ['icon' => 'shield',   'fa' => ['t' => 'امنیت', 'd' => 'حفاظت از سرویس‌های شما در برابر تهدیدات سایبری'],          'en' => ['t' => 'Security', 'd' => 'Protect your services against cyber threats'],          'tr' => ['t' => 'Güvenlik', 'd' => 'Hizmetlerinizi siber tehditlere karşı koruyun']],
        ['icon' => 'lifebuoy', 'fa' => ['t' => 'پشتیبانی وردپرس', 'd' => 'حل مشکلات وب‌سایت وردپرسی شما'],                'en' => ['t' => 'WordPress Care', 'd' => 'We fix your WordPress site issues'],              'tr' => ['t' => 'WordPress Bakımı', 'd' => 'WordPress sitenizin sorunlarını çözüyoruz']],
        ['icon' => 'lock',     'fa' => ['t' => 'گواهینامه SSL', 'd' => 'برای کاربران وب‌سایتتان محیطی امن‌تر بسازید'],     'en' => ['t' => 'SSL Certificates', 'd' => 'Build a safer environment for your users'],     'tr' => ['t' => 'SSL Sertifikaları', 'd' => 'Kullanıcılarınız için daha güvenli bir ortam']],
        ['icon' => 'key',      'fa' => ['t' => 'لایسنس‌ها', 'd' => 'خرید لایسنس اورجینال نرم‌افزارها'],                    'en' => ['t' => 'Licenses', 'd' => 'Original software license store'],                      'tr' => ['t' => 'Lisanslar', 'd' => 'Orijinal yazılım lisansları']],
        ['icon' => 'restore',  'fa' => ['t' => 'هاست بکاپ', 'd' => 'در صورت بروز مشکل، اطلاعات شما حفظ خواهد شد'],        'en' => ['t' => 'Backup Hosting', 'd' => 'Your data stays safe, whatever happens'],         'tr' => ['t' => 'Yedek Hosting', 'd' => 'Ne olursa olsun verileriniz güvende']],
        ['icon' => 'box',      'fa' => ['t' => 'خدمات بیشتر', 'd' => 'سایر خدمات تکمیلی سرورنت'],                          'en' => ['t' => 'More Services', 'd' => 'Other complementary services'],                    'tr' => ['t' => 'Diğer Hizmetler', 'd' => 'ServerNet\'in tamamlayıcı hizmetleri']],
    ],
    ...
    */
    'knowledge_menu' => [
        ['icon' => 'book',   'fa' => ['t' => 'بلاگ', 'd' => 'داستان‌های دنیای تکنولوژی و دیجیتال'],                 'en' => ['t' => 'Blog', 'd' => 'Stories from the tech & digital world'],       'tr' => ['t' => 'Blog', 'd' => 'Teknoloji ve dijital dünyadan hikayeler']],
        ['icon' => 'mic',    'fa' => ['t' => 'وبینارها', 'd' => 'آخرین وبینارهای سرورنت'],                           'en' => ['t' => 'Webinars', 'd' => 'Latest ServerNet webinars'],               'tr' => ['t' => 'Webinarlar', 'd' => 'ServerNet\'in son webinarları']],
        ['icon' => 'layout', 'fa' => ['t' => 'مستندات', 'd' => 'راهنمای استفاده از محصولات سرورنت'],                'en' => ['t' => 'Documentation', 'd' => 'Product guides & how-tos'],           'tr' => ['t' => 'Dokümantasyon', 'd' => 'Ürün kullanım kılavuzları']],
        ['icon' => 'cap',    'fa' => ['t' => 'سایر موارد آموزشی', 'd' => 'رویداد، دوره آموزشی، پادکست و…'],          'en' => ['t' => 'Learning & Events', 'd' => 'Events, courses, podcasts & more'], 'tr' => ['t' => 'Eğitim & Etkinlikler', 'd' => 'Etkinlik, kurs, podcast ve daha fazlası']],
        ['icon' => 'code',   'fa' => ['t' => 'ابزار توسعه‌دهندگان', 'd' => 'مستندات فنی برای آشنایی با API محصولات'], 'en' => ['t' => 'Developer API', 'd' => 'Technical docs for our product APIs'], 'tr' => ['t' => 'Geliştirici API', 'd' => 'Ürün API\'leri için teknik dokümanlar']],
    ],
];
