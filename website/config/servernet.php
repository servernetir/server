...
return [
    ...
    */
    ...
    'enterprise' => [
        ...
        ['icon' => 'mail', 'tag' => 'Amazon SES', 'slug' => 'email',
         'en' => ['t' => 'Transactional & Enterprise Email', 'd' => 'Bulk and transactional email on Amazon SES with the highest inbox-delivery rate — SPF/DKIM/DMARC, SMTP & API, full setup.'],
         'fa' => ['t' => 'ایمیل تراکنشی و سازمانی', 'd' => 'ارسال انبوه و تراکنشی روی Amazon SES با بالاترین نرخ تحویل — SPF/DKIM/DMARC، SMTP و API و راه‌اندازی کامل.'],
         'tr' => ['t' => 'İşlemsel ve Kurumsal E-posta', 'd' => 'Amazon SES üzerinde en yüksek teslim oranıyla toplu ve işlemsel e-posta — SPF/DKIM/DMARC, SMTP ve API, tam kurulum.']],
