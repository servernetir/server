...
return [
    ...
    'persian' => [
        ...
        'fa' => ['t' => 'دامنه فارسی',
            'seo_t' => 'ثبت دامنه فارسی (IDN) | آدرس سایت به خط فارسی',
            'seo_d' => 'ثبت دامنه فارسی (IDN) به خط فارسی مانند «فروشگاه‌من.ایران» برای برندهایی که مشتری فارسی‌زبان دارند؛ جستجوی آنلاین، پرداخت ریالی و مدیریت از پنل.',
            'tag' => 'IDN · دامنه به خط فارسی',
        ...
        'en' => ['t' => 'Persian IDN Domains',
            'seo_t' => 'Register Persian IDN Domain | addresses in Persian script',
            'seo_d' => 'Register Persian-script (IDN) domains such as «فروشگاه‌من.ایران» for brands whose customers read and type Persian; online search and full panel management.',
            'tag' => 'IDN · Domains in Persian script',
