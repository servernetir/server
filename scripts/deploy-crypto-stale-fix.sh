#!/usr/bin/env bash
#
# 🔴 دیپلویِ فوریِ امنیتِ مالی: واریزیِ قدیمی دیگر فاکتورِ تازه را تسویه نمی‌کند.
#
# اجرا از ترمینالِ cPanel:
#   bash <(curl -fsSL https://raw.githubusercontent.com/servernetir/server/<SHA>/scripts/deploy-crypto-stale-fix.sh) [<SHA>]
#
# ═══ چه چیزی را می‌بندد ═══
#
...
WORK="$HOME/deploy-crypto-stale-fix"
